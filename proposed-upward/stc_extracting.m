function [stc_decoded_msg] = stc_extracting(use_dcts,afterchannel_stego_Path,stc_n_msg_bits,stc_n_msg_bits_check,tab_m,n,k,m,l_check_check)
%% 提取载密序列元素
    ...
    G = 1;
    n_msg = 0;
    code_n = m_block*n_block*usable_DCT_num;  %中频9个DCT系数
...
%     block1=3;
%     block2=1;
    l_cover_embed=block1*k*m;%C1长度
    l_embed_check=block2*k*m;
