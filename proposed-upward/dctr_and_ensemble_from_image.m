...
%         file_index = index;
    ...
    cover_features_path = sprintf('/data1/lml/dctr_cover_features_ln%d_QF%d.mat',listNum, QF);
    if params.start == 0
        ...
        file_id = fopen('acc_log_ddmr.txt','a');
        fprintf(file_id,'Time: %s; dctr_%s-%.4f-%.4f-%.2f-jpeg-Q%d: %.4f\n', datestr(now),'ddmr',params.myp1, params.myp2,  payload, QF, test_acc);
        fclose(file_id);
