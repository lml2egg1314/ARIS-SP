...
# STEGANOGRAPHY = 's-uniward'
# EMBEDDING_RATE = 0.2

# BOSSBASE_COVER_DIR = '/data/cbl/steganalysis/BossBase-1.01-cover-resample-256'
# BOSSBASE_STEGO_DIR = '/data/cbl/steganalysis/BossBase-1.01-{}-{}-resample-256'.format(STEGANOGRAPHY, EMBEDDING_RATE)

# BOWS_COVER_DIR = '/data/cbl/steganalysis/BOWS2-cover-resample-256'
# BOWS_STEGO_DIR = '/data/cbl/steganalysis/BOWS2-{}-{}-resample-256'.format(STEGANOGRAPHY, EMBEDDING_RATE)
...
#KV_filter = np.array([[-1,2,-2,2,-1],[2,-6,8,-6,2],[-2,8,-12,8,-2],[2,-6,8,-6,2],[-1,2,-2,2,-1]], dtype=np.float32)/12
#P_filter = np.array([[0,0,5.2,0,0],[0,23.4,36.4,23.4,0],[5.2,36.4,-261,36.4,5.2],[0,23.4,36.4,23.4,0],[0,0,5.2,0,0]], dtype=np.float32)/261
...
#        block2(32,32)
      ...
      nn.Conv2d(62, 32, kernel_size=3, padding=1),
      nn.BatchNorm2d(32),
      nn.ReLU(),
...
#  Path(OUTPUT_PATH).mkdir(parents=True, exist_ok=True)
  ...
  BOSSBASE_COVER_DIR = '/data/dxq/jpeg/BossBase-1.01-cover-resample-256-jpeg-{}-non-rounded'.format(JPEG_QUALITY)
  BOSSBASE_STEGO_DIR = '/data/dxq/jpeg/BossBase-1.01-{}-{}-resample-256-jpeg-{}-non-rounded'.format(STEGANOGRAPHY, EMBEDDING_RATE, JPEG_QUALITY)

  BOWS_COVER_DIR = '/data/dxq/jpeg/BOWS2-cover-resample-256-jpeg-{}-non-rounded'.format(JPEG_QUALITY)
  BOWS_STEGO_DIR = '/data/dxq/jpeg/BOWS2-{}-{}-resample-256-jpeg-{}-non-rounded'.format(STEGANOGRAPHY, EMBEDDING_RATE, JPEG_QUALITY)
  ...
  PARAMS_NAME = '{}-{}-{}-params-{}-lr={}-{}-{}-{}_{}.pt'.format(STEGANOGRAPHY, EMBEDDING_RATE, DATASET_INDEX, TIMES, LR,EPOCH1,EPOCH2,EPOCH3, JPEG_QUALITY)
  LOG_NAME = '{}-{}-{}-model_log-{}-lr={}-{}-{}-{}_{}'.format(STEGANOGRAPHY, EMBEDDING_RATE, DATASET_INDEX, TIMES, LR,EPOCH1,EPOCH2,EPOCH3, JPEG_QUALITY)
  
  PARAMS_PATH = os.path.join(OUTPUT_PATH, PARAMS_NAME)
  LOG_PATH = os.path.join(OUTPUT_PATH, LOG_NAME)
  
  #transfer learning 
  PARAMS_INIT_NAME = '{}-{}-{}-params-{}-lr={}-{}-{}-{}_{}.pt'.format(STEGANOGRAPHY, LOAD_RATE, DATASET_INDEX, TIMES, LR, EPOCH1,EPOCH2,EPOCH3,JPEG_QUALITY)
  
  if LOAD_RATE == 0.4 and JPEG_QUALITY == '95':
    PARAMS_INIT_NAME = '{}-{}-{}-params-{}-lr={}-{}-{}-{}_{}.pt'.format(STEGANOGRAPHY, LOAD_RATE, DATASET_INDEX, TIMES, '0.005', 40,70,90,JPEG_QUALITY)
  ...
  if LOAD_RATE == 0.4 and JPEG_QUALITY=='75':
  	PARAMS_INIT_NAME = '{}-{}-{}-params-{}-lr={}-{}-{}-{}_{}.pt'.format(STEGANOGRAPHY, LOAD_RATE, DATASET_INDEX, TIMES, '0.02', 80,140,180, JPEG_QUALITY)
   
  if LOAD_RATE == 0.2 and JPEG_QUALITY=='75':
  	PARAMS_INIT_NAME = '{}-{}-{}-params-{}-lr={}-{}-{}-{}_{}.pt'.format(STEGANOGRAPHY, LOAD_RATE, DATASET_INDEX, TIMES, '0.01', 40,70,90, JPEG_QUALITY)
   
  if LOAD_RATE == 0.5 and JPEG_QUALITY=='95': 
  	PARAMS_INIT_NAME = '{}-{}-{}-params-{}-lr={}-{}-{}-{}_{}.pt'.format(STEGANOGRAPHY, EMBEDDING_RATE, DATASET_INDEX, TIMES, '0.02', 80,140,180, '75')
