...
#  Path(OUTPUT_PATH).mkdir(parents=True, exist_ok=True)
  ...
  BB_STEGO_DIR = '{}/BB-cover-resample-256-jpeg-{}-{}-upward-payload-{}-use-dcts-{}-none-round'.format(base_dir, JPEG_QUALITY, STEGANOGRAPHY, EMBEDDING_RATE, USE_DCTS)
  ...
  PARAMS_NAME = '{}-{}-{}-params_{}_use_dcts_{}.pt'.format(STEGANOGRAPHY, EMBEDDING_RATE, DATASET_INDEX,  JPEG_QUALITY, USE_DCTS)
  LOG_NAME = '{}-{}-{}-model_log_{}_use_dcts_{}'.format(STEGANOGRAPHY, EMBEDDING_RATE, DATASET_INDEX,  JPEG_QUALITY, USE_DCTS)
  
  PARAMS_PATH = os.path.join(OUTPUT_PATH, PARAMS_NAME)
  LOG_PATH = os.path.join(OUTPUT_PATH, LOG_NAME)
  
  #transfer learning 
  PARAMS_INIT_NAME = '{}-{:.2f}-{}-params_{}_use_dcts_{}.pt'.format(STEGANOGRAPHY, LOAD_RATE, DATASET_INDEX, JPEG_QUALITY, USE_DCTS)
  print(PARAMS_INIT_NAME)
