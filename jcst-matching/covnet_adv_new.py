...
#  Path(OUTPUT_PATH).mkdir(parents=True, exist_ok=True)
  ...
  BB_STEGO_DIR = '{}/BB-cover-resample-256-jpeg-{}-{}-new-payload-{}-ae1-{}-none-round'.format(base_dir, JPEG_QUALITY, STEGANOGRAPHY, EMBEDDING_RATE, ADVERSARIAL_RATE)
  ...
  PARAMS_NAME = '{}-{}-{}-params_new_{}_{}.pt'.format(STEGANOGRAPHY, EMBEDDING_RATE, DATASET_INDEX,  JPEG_QUALITY, ADVERSARIAL_RATE)
  LOG_NAME = '{}-{}-{}-model_log_new_{}_{}'.format(STEGANOGRAPHY, EMBEDDING_RATE, DATASET_INDEX,  JPEG_QUALITY, ADVERSARIAL_RATE)
  
  PARAMS_PATH = os.path.join(OUTPUT_PATH, PARAMS_NAME)
  LOG_PATH = os.path.join(OUTPUT_PATH, LOG_NAME)
  
  #transfer learning 
  PARAMS_INIT_NAME = '{}-{:.2f}-{}-params_new_{}_{}.pt'.format(STEGANOGRAPHY, LOAD_RATE, DATASET_INDEX, JPEG_QUALITY, ADVERSARIAL_RATE)
